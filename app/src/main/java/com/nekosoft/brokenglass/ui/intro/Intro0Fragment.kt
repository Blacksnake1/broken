...
class Intro0Fragment : BaseFragment<ItemIntro012Binding>() {
...
//        }
    ...
    private fun textPos() {
        Glide.with(requireContext()).load(R.drawable.intro_0).into(binding.imgView)
        binding.tvDes.text = getString(R.string.des_intro_1)
