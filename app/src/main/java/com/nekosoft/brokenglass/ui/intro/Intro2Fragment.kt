...
class Intro2Fragment : BaseFragment<ItemIntro012Binding>() {
...
//        }
    ...
    private fun textPos() {
        Glide.with(requireContext()).load(R.drawable.intro_2).into(binding.imgView)
        binding.tvDes.text = getString(R.string.des_intro_3)
        binding.btnStartNow.goneExt()
    }
}