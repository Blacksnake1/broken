...
import com.gianghv.libads.databinding.CustomNativeAdsDetailWallpaperBinding
import com.gianghv.libads.databinding.NativeFullScreenBinding
import com.google.android.gms.ads.nativead.MediaView
import com.google.android.gms.ads.nativead.NativeAdView

class CustomNativeAdsDetailWallpaper(context: Context, attrs: AttributeSet?) :
    BaseNativeAdView(context, attrs) {

    var mViewBinding: CustomNativeAdsDetailWallpaperBinding =
        CustomNativeAdsDetailWallpaperBinding.inflate(LayoutInflater.from(context), this, true)
