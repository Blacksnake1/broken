...
import com.gianghv.libads.databinding.CustomNativeAdsSettingBinding
import com.google.android.gms.ads.nativead.MediaView
import com.google.android.gms.ads.nativead.NativeAdView

class CustomNativeAdsSetting(context: Context, attrs: AttributeSet?) :
    BaseNativeAdView(context, attrs) {

    private var mViewBinding: CustomNativeAdsSettingBinding =
        CustomNativeAdsSettingBinding.inflate(LayoutInflater.from(context), this, true)
