...
import com.gianghv.libads.databinding.CustomNativeFullIntroBinding
import com.google.android.gms.ads.nativead.MediaView
import com.google.android.gms.ads.nativead.NativeAdView

class CustomNativeFullIntro(context: Context, attrs: AttributeSet?) :
    BaseNativeAdView(context, attrs) {

    var mViewBinding: CustomNativeFullIntroBinding =
        CustomNativeFullIntroBinding.inflate(LayoutInflater.from(context), this, true)

    fun initNativeEvent(onCloseAdsAction: (() -> Unit)) {
