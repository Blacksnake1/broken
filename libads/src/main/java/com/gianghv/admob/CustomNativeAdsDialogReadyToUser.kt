...
import com.gianghv.libads.databinding.CustomNativeAdsDialogReadyToUserBinding
...
class CustomNativeAdsDialogReadyToUser(context: Context, attrs: AttributeSet?) :
    BaseNativeAdView(context, attrs) {

    var mViewBinding: CustomNativeAdsDialogReadyToUserBinding =
        CustomNativeAdsDialogReadyToUserBinding.inflate(LayoutInflater.from(context), this, true)
