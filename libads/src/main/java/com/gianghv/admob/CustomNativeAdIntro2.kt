...
class CustomNativeAdIntro2(context: Context, attrs: AttributeSet?) :
    BaseNativeAdView(context, attrs) {

    private var mViewBinding: CustomNativeAdsIntro2Binding =
        CustomNativeAdsIntro2Binding.inflate(LayoutInflater.from(context), this, true)
