...
import com.gianghv.libads.databinding.CustomNativeAdsItemFireScreenBinding
import com.google.android.gms.ads.nativead.MediaView
import com.google.android.gms.ads.nativead.NativeAdView

class CustomNativeAdsItemFireScreen(context: Context, attrs: AttributeSet?) :
    BaseNativeAdView(context, attrs) {

    var mViewBinding: CustomNativeAdsItemFireScreenBinding =
        CustomNativeAdsItemFireScreenBinding.inflate(LayoutInflater.from(context), this, true)
