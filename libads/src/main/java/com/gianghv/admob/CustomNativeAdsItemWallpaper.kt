...
import com.gianghv.libads.databinding.CustomNativeAdsItemWallpaperBinding
import com.gianghv.libads.databinding.NativeFullScreenBinding
import com.google.android.gms.ads.nativead.MediaView
import com.google.android.gms.ads.nativead.NativeAdView

class CustomNativeAdsItemWallpaper(context: Context, attrs: AttributeSet?) :
    BaseNativeAdView(context, attrs) {

    var mViewBinding: CustomNativeAdsItemWallpaperBinding =
        CustomNativeAdsItemWallpaperBinding.inflate(LayoutInflater.from(context), this, true)
