...
import com.gianghv.libads.databinding.CustomNativeAdsDetailBrokenScreenBinding
import com.gianghv.libads.databinding.CustomNativeAdsIntro2Binding
import com.google.android.gms.ads.nativead.MediaView
import com.google.android.gms.ads.nativead.NativeAdView

class CustomNativeAdsDetailBrokenScreen(context: Context, attrs: AttributeSet?) :
    BaseNativeAdView(context, attrs) {

    private var mViewBinding: CustomNativeAdsDetailBrokenScreenBinding =
        CustomNativeAdsDetailBrokenScreenBinding.inflate(LayoutInflater.from(context), this, true)
    ...
    override fun getIconView(): ImageView? = mViewBinding.imgAvt
