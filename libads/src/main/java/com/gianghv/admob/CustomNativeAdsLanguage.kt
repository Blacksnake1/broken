...
import com.gianghv.libads.databinding.CustomNativeAdsLanguageBinding
import com.google.android.gms.ads.nativead.MediaView
import com.google.android.gms.ads.nativead.NativeAdView

class CustomNativeAdsLanguage(context: Context, attrs: AttributeSet?) :
    BaseNativeAdView(context, attrs) {

    private var mViewBinding: CustomNativeAdsLanguageBinding =
        CustomNativeAdsLanguageBinding.inflate(
