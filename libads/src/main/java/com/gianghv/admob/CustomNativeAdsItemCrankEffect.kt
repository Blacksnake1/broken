...
class CustomNativeAdsItemCrankEffect(context: Context, attrs: AttributeSet?) :
    BaseNativeAdView(context, attrs) {

    var mViewBinding: CustomNativeAdsItemCrankEffectBinding =
        CustomNativeAdsItemCrankEffectBinding.inflate(LayoutInflater.from(context), this, true)
